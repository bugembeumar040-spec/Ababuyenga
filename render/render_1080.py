...
# ---------------------------------------------------------------- cue sheet
CUES = [
 (0.40, 2.86, "cap1",  dict(lines=["THE CARD INDUSTRY","CALLS YOU"], top=250)),
 (1.90, 2.86, "acc",   dict(text="A DEADBEAT", top=470)),
 ...
 (11.00,12.45,"cA",    dict(label="INTEREST EARNED", value="£0.00", cx=540, cy=1290, w=520)),
 (13.25,15.40,"cap1",  dict(lines=["YOU WERE NEVER","THE CUSTOMER"], top=250)),
 (16.35,18.80,"cap1",  dict(lines=["THE CARD ISN'T","THE PRODUCT"], top=200)),
 (17.40,18.80,"cap2",  dict(text="the balance is", top=400)),
 (19.50,23.20,"cap1",  dict(lines=["THE LIMIT WENT UP","ON ITS OWN"], top=230)),
 (20.30,23.20,"cA",    dict(label="LIMIT", value="£2,000 → £3,500", cx=540, cy=1240, w=660)),
 ...
 (29.80,30.80,"cap2",  dict(text="bait, not a gift", top=600)),
 (31.60,34.20,"cap1",  dict(lines=["ITS OWN","LITTLE BOX"], top=200)),
 (32.30,34.20,"sml",   dict(text="£25", cx=756, top=1430, size=62)),
 (32.30,34.20,"sml",   dict(text="MINIMUM PAYMENT", cx=360, top=1448, size=34)),
 ...
 (58.10,59.40,"cC",    dict(text="BALANCE £0.00", cy=520, size=76)),
